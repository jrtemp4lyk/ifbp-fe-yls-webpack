...
import loanlistdlogdef from "./loanapply-detail-inout-dlog.vue";
import loanlistdef from "./loanapply-detail-inout.vue";
import deductedlistdlogdef from "./loanapply-detail-info.vue";
export default {
  components: {
    loanlistdlogdef,
    loanlistdef: loanlistdef,
    deductedlistdlogdef:deductedlistdlogdef,
  },
  data() {
    var oThis = this;
    return {
