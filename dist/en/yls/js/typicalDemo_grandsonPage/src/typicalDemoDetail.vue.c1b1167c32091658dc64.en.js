define("yls//typicalDemo_grandsonPage/src/typicalDemoDetail.vue", function(require, exports, module) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__typicalDemoDetail_grandson_Child_js__ = __webpack_require__(340);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__typicalDemoDetail_grandson_Child_js__["a" /* default */]],
  props: ['value'],
  data() {
    var vm = this;
  ...
  methods: {
    ...
    requestTypicalDemoBaseInfo() {
      this.$refs.typicalDemoGrandsonRef.setData("TypicalDemoEntity", value);
    },
    // 基本信息取消按钮操作
    typicalDemoCancel() {
      this.typicalDemoEdit = false;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "id": "basePanel",
      "title": "基本信息",
      "icons": _vm.typicalDemoIcons
    }
  }, [_c('ifbp-template', {
    ref: "typicalDemoRef",
    attrs: {
      "tplId": "typicalDemoId",
      "funnode": _vm.typicalDemoFunnode,
      "nexuskey": _vm.typicalDemoNexuskey,
      "show-type": "form",
      "tplData": _vm.typicalDemoData,
      "editable": _vm.typicalDemoEdit
    }
  }), _vm._v(" "), (_vm.typicalDemoEdit) ? _c('div', {
    ...
    on: {
      "click": _vm.typicalDemoConfirm
    }
  }, [_vm._v("保存")])], 1) : _vm._e()], 1), _vm._v(" "), _c('ifbp-panel', {
    attrs: {
      "id": "childPanel",
      "title": "子表信息",
      "icons": _vm.childIcons
    }
  }, [_c('ifbp-template', {
    ref: "typicalDemoChildRef",
    attrs: {
      "tpl-id": "typicalDemoChildId",
      "funnode": _vm.typicalDemoChildFunnode,
      "nexuskey": _vm.typicalDemoChildNexuskey,
      "tpl-data": _vm.typicalDemoChildData,
      "show-type": "table-form",
      "tpl-reset-fun": _vm.typicalDemoChildResetFun
    },
    on: {
      "edit-table-click": _vm.childEditClick,
      "delete-table-click": _vm.childDeleteClick,
      "form-confirm-click": _vm.childFormConfirm,
      "form-cancel-click": _vm.childFormCancel
    }
    ...
    on: {
      "click": _vm.childDeleteDialogClick
    },
    model: {
      value: (_vm.childDelDialogVisible),
      callback: function($$v) {
        _vm.childDelDialogVisible = $$v
      },
      expression: "childDelDialogVisible"
    }
  })], 1)], 1)], 1)
},staticRenderFns: []}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__typicalDemoDetailChild_js__ = __webpack_require__(693);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__typicalDemoDetail_grandson_vue__ = __webpack_require__(390);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__typicalDemoDetail_grandson_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__typicalDemoDetail_grandson_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__typicalDemoDetailChild_js__["a" /* default */]],
  components: {
    'typicalDemoDetailGrandson': __WEBPACK_IMPORTED_MODULE_1__typicalDemoDetail_grandson_vue___default.a
  },
  data() {
    var vm = this;
    var id = this.$root.$router.currentRoute.params.id;
  ...
  methods: {
    ...
    requestTypicalDemoBaseInfo() {
      ...
      this.$http({
        ...
        if (res.data.success === true) {
          this.$refs.typicalDemoRef.setData("TypicalDemoEntity", res.data.data);
        ...
        if (valid) {
          ...
          vm.$http({
            ...
            if (res.data.success) {
              ...
              vm.$refs.typicalDemoRef.setData("TypicalDemoEntity", res.data.data);
              vm.baseData = JSON.parse(JSON.stringify(res.data.data));
              vm.typicalDemoEdit = false;
            } else {
              vm.$message({
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })], 1)], 1), _vm._v(" "), _c('ifbp-grandson-page', {
    ref: "grandsonPage",
    attrs: {
      "title": "孙表信息",
      "width": "900"
    }
  }, [_c('typicalDemoDetailGrandson', {
    ref: "typicalDemoChildFormRef",
    attrs: {
      "value": _vm.currentChildRowValue
    }
  })], 1)], 1)])
    ...
    requestTypicalDemoChild() {
      ...
      this.$http({
        ...
        if (res.data.success === true) {
          this.$nextTick(() => {
            var resData = res.data.data.content;
            this.$refs.typicalDemoChildRef.setData('TypicalDemoChildEntity_t', resData);
            this.$refs.typicalDemoChildRef.tableShow = resData.length < 1 ? false : true;
          });
        } else {
          this.$message({
...
/******/ })});;
//# sourceMappingURL=typicalDemoDetail.vue.c1b1167c32091658dc64.en.js.map