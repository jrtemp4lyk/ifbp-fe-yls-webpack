    ...
    request() {
      ...
      this.$http({
        ...
        if (res.data.success === true) {
          ...
          this.$refs['InterestRate-table'].setTableData(JSON.parse(JSON.stringify(originalValue)));
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    ref: "InterestRate-table",
    attrs: {
      "tplId": "interestRate-table-template",
      "funnode": _vm.funnode,
      "nexuskey": _vm.nexuskey,
      "tplData": _vm.interestRateTableData,
      "show-type": "table",
...
/******/ })});;
//# sourceMappingURL=interestRate-table.vue.9a2cff58428070c45a3b.en.js.map