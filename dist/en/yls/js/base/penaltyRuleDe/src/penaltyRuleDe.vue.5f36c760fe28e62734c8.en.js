  ...
  data() {
    ...
    return {
      ...
      tMethods: {
        ...
        confirmClick(data) {
          this.$http({
            url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "contr/penaltyRuleDe/updateStatus",
  ...
  methods: {
    ...
    request(n, s) {
      ...
      this.$http({
        ...
        this.$refs['penaltyRuleDeRef'].setData('PenaltyRuleDe_t', JSON.parse(JSON.stringify(originalValue)));
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "tpl-data": _vm.penaltyRuleDeTableData,
      "tpl-reset-fun": _vm.penaltyRuleDeTableResetFun,
      "methods": _vm.tMethods,
      "show-type": "table-form"
    },
    on: {
      "form-confirm-click": _vm.penaltyRuleDeConfirm,
      "form-cancel-click": _vm.penaltyRuleDeCancel,
...
/******/ })});;
//# sourceMappingURL=penaltyRuleDe.vue.5f36c760fe28e62734c8.en.js.map