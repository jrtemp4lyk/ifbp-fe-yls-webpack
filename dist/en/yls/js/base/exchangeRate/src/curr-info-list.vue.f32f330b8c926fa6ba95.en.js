...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deleteConfirmClick() {
            this.$http({
                url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["g" /* ylsBase */] + 'currInfo/deleteById',
        ...
        request() {
            ...
            this.$http({
                url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["g" /* ylsBase */] + 'currInfo/page',
                headers: { 'Content-Type': 'application/json' },
                method: 'post',
                data: data,
                dataType: 'json'
                ...
                if (res.data.success === true) {
                    ...
                    this.$refs['currInfoList-table'].setData('CurrInfo_t', originalValue);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    ref: "currInfoList-table",
    attrs: {
      "tplId": "currInfoList-template",
      "funnode": _vm.funNode,
      "nexuskey": _vm.nexusKey,
      "tplData": _vm.currInfoListData,
      "show-type": "table",
...
/******/ })});;
//# sourceMappingURL=curr-info-list.vue.f32f330b8c926fa6ba95.en.js.map