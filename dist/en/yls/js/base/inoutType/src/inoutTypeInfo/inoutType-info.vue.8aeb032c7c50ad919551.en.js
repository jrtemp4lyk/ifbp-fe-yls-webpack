...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    request() {
      ...
      this.$http({
        url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["g" /* ylsBase */] + 'inoutType/page',
        ...
        if (res.data.success === true) {
          ...
          this.$refs['inoutType-table'].setData('InoutType_t', this.originalValue);
    ...
    deleteClick() {
      ...
      this.$http({
        url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["g" /* ylsBase */] + 'inoutType/deleteById',
        headers: { 'Content-type': 'application/json' },
        method: 'post',
        dataType: 'json',
        data: delId
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "tpl-data": _vm.inoutTypeTableData,
      "show-type": "table",
      "tpl-reset-fun": _vm.inoutTypeTableResetFun
    },
    on: {
...
/******/ })});;
//# sourceMappingURL=inoutType-info.vue.8aeb032c7c50ad919551.en.js.map