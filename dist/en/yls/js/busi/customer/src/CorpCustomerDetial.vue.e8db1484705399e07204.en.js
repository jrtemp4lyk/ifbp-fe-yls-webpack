...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "tplResetFun": _vm.customerResetFun,
      "tpl-data": _vm.customerBaseData,
    ...
    attrs: {
      ...
      "methods": _vm.t_Methods,
      "tplData": _vm.customerDetailData,
      "editable": _vm.customerEdit
    }
  ...
  })], 1) : _vm._e(), _vm._v(" "), (_vm.isshow) ? _c('ifbp-panel', {
    attrs: {
      "id": "BankAccountPanel",
      "show-body": false,
      "title": "银行账户信息",
    ...
    attrs: {
      "id": "QualificationCertPanel",
      "show-body": false,
      "title": "资质认证信息",
      "icons": _vm.QualificationCertIcons
    }
  }, [_c('QualificationCertRef', {
    ref: "QualificationCertRef",
    attrs: {
      "pk_customer": _vm.pk_customer
    }
    ...
    attrs: {
      "id": "LitigationSituationPanel",
      "show-body": false,
      "title": "涉诉信息",
      "icons": _vm.LitigationSituationIcons
    }
  }, [_c('LitigationSituationRef', {
    ref: "LitigationSituationRef",
    attrs: {
      "pk_customer": _vm.pk_customer
    }
    ...
    on: {
      "click": function($event) {
        _vm.reloadVisible = false, _vm.pk_customer = ''
      }
    }
  }, [_vm._v("取 消")]), _vm._v(" "), _c('el-button', {
    attrs: {
...
/******/ })});;
//# sourceMappingURL=CorpCustomerDetial.vue.e8db1484705399e07204.en.js.map