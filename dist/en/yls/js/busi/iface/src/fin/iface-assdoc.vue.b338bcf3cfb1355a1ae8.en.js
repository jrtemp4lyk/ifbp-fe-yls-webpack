...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    templateTableFormConfirm(type) {
      this.$refs.assdocForm.validate(valid => {
        if (valid) {
          if (type === 'form' || type === 'table-form') {
            var formData = this.$refs.assdocForm.getData('IfaceAssDoc');
            var url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'iface/assdoc/create';
            if (type === 'table-form') {
              url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'iface/assdoc/update';
            }
            this.$http({
              url: url,
              method: 'POST',
              ...
              if (res.data.success) {
                if (type === 'table-form') {
                  ...
                  debugger;
                  var typeList = this.$refs.assdocForm.getData('IfaceAssDoc_t');
    ...
    deleteConfirmClick() {
      this.$http({
        url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "/iface/assdoc/deleteById",
    ...
    //后台请求
    request() {
      var url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "iface/assdoc/page";
      var data = {
        orderList: [{
          direction: "desc",
          property: "ts"
      ...
      this.$http({
        ...
        this.$refs.assdocForm.setData('IfaceAssDoc_t', originalValue);
...
/******/ })});;
//# sourceMappingURL=iface-assdoc.vue.b338bcf3cfb1355a1ae8.en.js.map