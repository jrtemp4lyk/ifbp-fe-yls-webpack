...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      this.$refs.accnameForm.validate(valid => {
        if (valid) {
          if (type === 'form' || type === 'table-form') {
            ...
            var url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'iface/accname/create';
            if (type === 'table-form') {
              url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'iface/accname/update';
            }
            this.$http({
              url: url,
              method: 'POST',
    ...
    deleteConfirmClick() {
      this.$http({
        url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "/iface/accname/deleteById",
    ...
    //后台请求
    request() {
      var url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "iface/accname/page";
      var data = {
        orderList: [{
          direction: "desc",
          property: "ts"
...
/******/ })});;
//# sourceMappingURL=iface-accname.vue.efdded054f3108095949.en.js.map