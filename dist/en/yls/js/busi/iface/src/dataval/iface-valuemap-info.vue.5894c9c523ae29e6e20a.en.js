...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      this.$refs.valuemapForm.validate(valid => {
        if (valid) {
          if (type === 'form' || type === 'table-form') {
            ...
            var url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'iface/valuemap/create';
            if (type === 'table-form') {
              url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'iface/valuemap/update';
            }
            this.$http({
              url: url,
              method: 'POST',
    ...
    deleteConfirmClick() {
      this.$http({
        url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "/iface/valuemap/deleteById",
    ...
    //后台请求
    request() {
      var url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "iface/valuemap/page";
      var data = {
        orderList: [{
          direction: "desc",
          property: "ts"
...
/******/ })});;
//# sourceMappingURL=iface-valuemap-info.vue.5894c9c523ae29e6e20a.en.js.map