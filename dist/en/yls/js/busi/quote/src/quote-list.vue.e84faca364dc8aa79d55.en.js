...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deleteConfirmClick() {
            this.$http({
                url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'quote/calc/deleteById',
        ...
        request() {
            ...
            this.$http({
                url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'quote/calc/page',
                headers: { 'Content-Type': 'application/json' },
                method: 'post',
                data,
                dataType: 'json'
                ...
                this.$refs['quoteList-table'].setData('QuoteCalculator_table', originalValue);
...
/******/ })});;
//# sourceMappingURL=quote-list.vue.e84faca364dc8aa79d55.en.js.map