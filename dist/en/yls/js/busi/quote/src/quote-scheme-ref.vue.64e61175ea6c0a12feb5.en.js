...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "field": _vm.field,
      "template-value": _vm.refTemplateValue,
      "is-edit": _vm.isEdit
    },
    on: {
      "trigger": _vm.onChange,
      "reset": _vm.onReset
    }
  })], 1), _vm._v(" "), _vm._l((_vm.templist), function(item, index) {
    return _c('ifbp-panel', {
      key: item.temp_id,
      attrs: {
        "id": 'productPreviewDetail' + index,
        "title": item.temp_title,
        "icons": _vm.plusIcons[item.temp_type + 'PlusIcons']
      }
    }, [_c('ifbp-template', {
      ref: item.temp_type + 'Ref',
      refInFor: true,
      attrs: {
        "tplId": item.temp_id,
        "pkTemp": item.temp_id,
        "tplData": _vm.tplData[item.temp_type + 'Data'],
        "tplResetFun": function($node) {
          _vm.tplResetFun($node, item.temp_type)
        },
        "editable": _vm.editable
      },
      on: {
        "form-confirm-click": function($event) {
          _vm.formConfirm(item.temp_type)
        },
        "form-cancel-click": function($event) {
          _vm.formCancel(item.temp_type)
        },
        "edit-table-click": function($event) {
          _vm.editTableRow(item.temp_type)
        },
        "delete-table-click": function($event) {
          _vm.deleteTableRow(item.temp_type)
        }
      }
    })], 1)
  })], 2)], 1)])
...
/******/ })});;
//# sourceMappingURL=quote-scheme-ref.vue.64e61175ea6c0a12feb5.en.js.map