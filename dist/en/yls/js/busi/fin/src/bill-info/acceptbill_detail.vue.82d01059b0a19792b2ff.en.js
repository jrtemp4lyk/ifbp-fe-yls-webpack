  ...
  methods: {
    ...
    clickSave() {
      ...
      if (data1.pk_accept_bill) {
        url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "fin/acceptBill/update";
      } else {
        url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + "fin/acceptBill/create";
      }
      this.$http({
        url: url,
        method: "post",
        ...
        this.$refs["baseTemplateRef"].setData('AcceptBill_t', originalValue);
        this.$message({
          message: '保存成功',
          type: 'success'
        });
    ...
    loadDemoInfo(pk_accept_bill) {
      this.$http({
        url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'fin/acceptBill/getById',
        headers: { 'Content-Type': 'application/json' },
        method: 'post',
        data: this.pk_accept_bill
      }).then(res => {
        let originalValue = res.data.data;
        this.$refs['baseTemplateRef'].setData('AcceptBill', JSON.parse(JSON.stringify(originalValue)));
      }).catch(e => {
        this.$message({
          message: '详情获取失败',
          type: 'error'
...
/******/ })});;
//# sourceMappingURL=acceptbill_detail.vue.82d01059b0a19792b2ff.en.js.map