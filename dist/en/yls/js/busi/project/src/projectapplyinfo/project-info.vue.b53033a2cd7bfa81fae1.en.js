  ...
  methods: {
    ...
    request(n, s) {
      ...
      this.$http({
        ...
        this.$refs["template-table"].setData("project_t", JSON.parse(JSON.stringify(this.originalValue)));
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "pkTemp": _vm.projectPk,
      "tplData": _vm.projectTableData,
      "show-type": "table",
      "tplResetFun": _vm.projectTableResetFun
    },
    on: {
...
/******/ })});;
//# sourceMappingURL=project-info.vue.b53033a2cd7bfa81fae1.en.js.map