...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    ...
    return {
      ...
      linkmanTableData: {},
      projectTableMethods: {},
      linkmanTableResetFun: function ($node) {
        debugger;
  ...
  methods: {
    ...
    request(n, s) {
      ...
      this.$http({
        ...
        this.$refs["template-table"].setData("linkmanLeader_t", JSON.parse(JSON.stringify(this.originalValue)));
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      ...
      "tplData": _vm.linkmanTableData,
      "show-type": "table",
      "tplResetFun": _vm.linkmanTableResetFun
    },
    on: {
...
/******/ })});;
//# sourceMappingURL=linkman-info.vue.72cc869e7deb01f33b87.en.js.map