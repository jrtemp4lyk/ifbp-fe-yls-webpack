...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    requestCustBaseInfo() {
      ...
      this.$http({
        ...
        if (res.data.success === true) {
          ...
          this.$refs.baseTemplateRef.setData("linkmanLeader", JSON.parse(JSON.stringify(originalValue)));
        } else {
          this.$message({
    ...
    customerConfirm() {
      ...
      debugger;
      this.$refs.baseTemplateRef.comp.$refs["linkman-form"].validate(valid => {
        if (valid) {
          this.$http({
            url: url,
            headers: { 'Content-Type': 'application/json' },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "tplId": "baseTemplate",
      "pkTemp": _vm.linkmanPk,
      "show-type": "form",
      "tplData": _vm.linkmanData,
      "editable": _vm.linkmanEdit
    }
  }), _vm._v(" "), (_vm.linkmanEdit) ? _c('div', {
...
/******/ })});;
//# sourceMappingURL=linkman-detail.vue.5827a5df99baa638897b.en.js.map