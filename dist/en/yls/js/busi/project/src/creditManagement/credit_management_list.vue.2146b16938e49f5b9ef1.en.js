...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        request() {
            var url = __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'creditManagement/getCreditManagementList';
            var data = {
                'orderList': [{
                    'direction': 'desc',
                    'property': 'ts'
        ...
        deleteConfirmClick() {
            this.$http({
                url: __WEBPACK_IMPORTED_MODULE_0__common_js_publicData_js__["c" /* ylsBusi */] + 'creditManagement/deleteCreditManagement',
                headers: { 'Content-Type': 'application/json' },
                method: 'post',
                dataType: 'json',
                data: this.delId
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": _vm.addcreditManagementInfo
    }
  }, [_vm._v("新增")])], 1)]), _vm._v(" "), _c('div', {
    staticClass: "list-main-container clearfix"
  }, [_c('ifbp-template', {
    ref: "creditManagementListRef",
    attrs: {
      "tplId": "creditManagementList",
      "funnode": _vm.creditManagementListFunnode,
      "nexuskey": _vm.creditManagementListNexuskey,
      "tplData": _vm.creditManagementListData,
      "show-type": "table",
      "tplResetFun": _vm.creditManagementListResetFun
    },
    on: {
...
/******/ })});;
//# sourceMappingURL=credit_management_list.vue.2146b16938e49f5b9ef1.en.js.map