  ...
  methods: {
    ...
    request() {
      ...
      this.$http({
        ...
        this.$refs['prjApproval-table'].setData('projectApproval_t', JSON.parse(JSON.stringify(originalValue)));
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    ref: "prjApproval-table",
    attrs: {
      "tplId": "prjApproval-table-template",
      "funnode": _vm.funnode,
      "nexuskey": _vm.nexuskey,
      "tplData": _vm.tableData,
      "show-type": "table",
...
/******/ })});;
//# sourceMappingURL=projectApproval-table.vue.85f9095c1fbe473b82c6.en.js.map