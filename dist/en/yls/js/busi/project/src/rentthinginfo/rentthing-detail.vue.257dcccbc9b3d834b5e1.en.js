...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    requestCustBaseInfo() {
      ...
      this.$http({
        ...
        if (res.data.success === true) {
          ...
          this.$refs.baseTemplateRef.setData("projectRentThing", JSON.parse(JSON.stringify(originalValue)));
        } else {
          this.$message({
    ...
    customerConfirm() {
      ...
      this.$refs.baseTemplateRef.comp.$refs["proRentThing-form"].validate(valid => {
        if (valid) {
          this.$http({
            url: url,
            headers: { 'Content-Type': 'application/json' },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "tplId": "baseTemplate",
      "pkTemp": _vm.rentthingPk,
      "show-type": "form",
      "tplData": _vm.rentthingData,
      "editable": _vm.rentthingEdit
    }
  }), _vm._v(" "), (_vm.rentthingEdit) ? _c('div', {
...
/******/ })});;
//# sourceMappingURL=rentthing-detail.vue.257dcccbc9b3d834b5e1.en.js.map