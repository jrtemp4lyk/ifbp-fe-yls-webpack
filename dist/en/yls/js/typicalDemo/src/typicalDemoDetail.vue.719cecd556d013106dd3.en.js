define("yls//typicalDemo/src/typicalDemoDetail.vue", function(require, exports, module) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__typicalDemoDetailChild_js__ = __webpack_require__(692);
//
//
//
//
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    childEditClick(scope) {
      ...
      this.$refs.typicalDemoChildRef.setData('TypicalDemoChildEntity', scope.row);
      // 备份数据
    ...
    childFormConfirm(type) {
      ...
      this.$refs.typicalDemoChildRef.validate(valid => {
        if (valid) {
          var data = vm.$refs.typicalDemoChildRef.getData('TypicalDemoChildEntity');
          // 拼接主表的id
          data = $.extend(data, {
            pk_example: vm.id
          });
    ...
    childFormCancel(type) {
      if (type === 'form') {
        ...
        this.$refs.typicalDemoChildRef.getTableComp().closeExpandRow();
        var childT = this.$refs.typicalDemoChildRef.getData('TypicalDemoChildEntity_t');
        childT[this.childEditIndex] = this.childBaseData;
        this.$refs.typicalDemoChildRef.setData('TypicalDemoChildEntity_t', childT);
      }
    },
    // table行的删除操作
...
/******/ })});;
//# sourceMappingURL=typicalDemoDetail.vue.719cecd556d013106dd3.en.js.map